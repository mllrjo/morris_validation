...
def analyze_morris_scaling_law(results: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    for result in results:
        if 'final_memorization' in result and 'model_config' in result:
            ...
            memorization_bits.append(memo['morris_memorization_bits'])
    ...
    avg_bits_per_param = np.mean(bits_per_param)
    std_bits_per_param = np.std(bits_per_param)
    ...
    scaling_validation = {
        ...
        'std_bits_per_param': std_bits_per_param,
        'target_bits_per_param': morris_target,
        'tolerance': tolerance,
    ...
    analysis = {
        ...
        'model_parameters_range': [min(model_params), max(model_params)],
        'memorization_range': [min(memorization_bits), max(memorization_bits)],
        'efficiency_scores': {
            'mean': np.mean(efficiency_scores),
            'std': np.std(efficiency_scores),
            'individual': list(zip(model_names, efficiency_scores))
        },
        'power_law_fit': {
